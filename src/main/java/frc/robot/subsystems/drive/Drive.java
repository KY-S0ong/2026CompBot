...
public class Drive extends SubsystemBase {
  ...
  public void periodic() {
     ...
     * LimelightHelpers.getBotPose2d(Constants.limeLight), Timer.getFPGATimestamp(),
     * null);
     * }
     */
  ...
  public void updateSmartDashboard() {
    ...
    SmartDashboard.putNumber("Shift Time", Robot.getMatchPeriodTime());
    SmartDashboard.putBoolean("Hub Active", Robot.isHubActive());
  }
}
