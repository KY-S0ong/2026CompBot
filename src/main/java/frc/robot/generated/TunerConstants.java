...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.11).withKV(0.78);
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(17.58);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(-0.039794921875);
   ...
   * <p>}
   *
   * <p>/** Swerve Drive class utilizing CTR Electronics' Phoenix 6 API with the selected device
   * types.
   */
